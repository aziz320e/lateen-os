/**
 * Cross-cutting primitives for the Customer Success Engine.
 *
...
/** Audit timestamps present on all Customer Success Engine aggregates. */
export type Auditable = Pick<AuditInfo, 'createdAt' | 'updatedAt'>;

/** Tenant scope — every Customer Success Engine aggregate belongs to one organization. */
