...
import type { ConversationId, WorkflowRequestId } from '../shared/identifiers.js';
import type { ISODateTime } from '../shared/primitives.js';

export type { WorkflowRequestId };

/** Deterministic communication workflow request type. */
export type CommunicationWorkflowType = 'approval_reminder' | 'follow_up_reminder' | 'overdue_notification' | 'escalation_notification';
