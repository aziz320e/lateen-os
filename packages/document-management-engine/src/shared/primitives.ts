/**
 * Cross-cutting primitives for the Document Management Engine.
 *
...
/** Audit timestamps present on all Document Management Engine aggregates. */
export type Auditable = Pick<AuditInfo, 'createdAt' | 'updatedAt'>;

/** Tenant scope — every Document Management Engine aggregate belongs to one organization. */
