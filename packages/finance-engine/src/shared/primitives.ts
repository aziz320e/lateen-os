/**
 * Cross-cutting primitives for the Finance Engine.
 *
...
/** Audit timestamps present on all Finance Engine aggregates. */
export type Auditable = Pick<AuditInfo, 'createdAt' | 'updatedAt'>;

/** Tenant scope — every Finance Engine aggregate belongs to one organization. */
