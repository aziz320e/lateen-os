/**
 * Deterministic calendar-date arithmetic over `YYYY-MM-DD` strings,
 * shared by every module that needs period/due-date/recurrence math
 * (financial organization, general ledger, AR/AP aging, budgets).
 *
 * @module shared/date
 */
