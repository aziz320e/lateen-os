/**
 * Cross-cutting primitives for the Project Management Engine.
 *
...
/** Audit timestamps present on all Project Management Engine aggregates. */
export type Auditable = Pick<AuditInfo, 'createdAt' | 'updatedAt'>;

/** Tenant scope — every Project Management Engine aggregate belongs to one organization. */
