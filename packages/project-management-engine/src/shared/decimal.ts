/**
 * Deterministic decimal-string money/quantity arithmetic, shared by
 * every Project Management Engine module that touches cost or value
 * (Budget Tracking, Material Planning, Time Tracking). Amounts are
 * decimal strings (see `@lateen-os/shared-kernel`'s {@link Money}) —
 * this module is the single place that parses and re-formats them.
 *
...
/** Formats a number as a fixed 2-decimal-place money/cost string. */
