/**
 * Repository port interfaces for Admin Console aggregates.
 *
...
/** Read-side repository port, scoped to one organization. */
...
/** Write-side repository port, scoped to one organization. */
...
/** Combined read/write repository port, scoped to one organization. */
