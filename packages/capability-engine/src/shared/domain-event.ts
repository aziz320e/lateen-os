/**
 * Domain event foundation for the Capability Engine.
 * Events follow the `{entity}.{action}` naming convention.
 *
...
/** Base domain event for Capability Engine aggregates and relations. */
