...
import { daysBetweenIso } from '../src/shared/date.js';
...
describe('shared/decimal — toMoney rounding edge cases', () => {
...
describe('shared/id', () => {
  it('generateId includes the given prefix', () => {
    expect(generateId('inventory-item')).toMatch(/^inventory-item-/);
  });
