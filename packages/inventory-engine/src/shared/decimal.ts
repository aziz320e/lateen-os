 ...
 * every Inventory Engine module that touches cost or value (Stock
 * Valuation, Procurement Preparation). Amounts are decimal strings
 * (see `@lateen-os/shared-kernel`'s {@link Money}) — this module is
 * the single place that parses and re-formats them.
 *
