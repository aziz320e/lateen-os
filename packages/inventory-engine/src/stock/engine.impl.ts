...
export function computeAvailableQuantity(stockLevel: Pick<StockLevel, 'quantityOnHand' | 'reservedQuantity' | 'damagedQuantity'>): string {
  return subtractAmounts(subtractAmounts(stockLevel.quantityOnHand, stockLevel.reservedQuantity), stockLevel.damagedQuantity);
}
...
export interface InventoryStockEngine {
  ...
  getOrCreate(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId): Promise<StockLevel>;
  setThresholds(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId, input: SetStockThresholdsInput): Promise<StockLevel>;
  get(organizationId: OrganizationId, stockLevelId: StockLevelId): Promise<StockLevel | null>;
  getByItemAndWarehouse(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId): Promise<StockLevel | null>;
  ...
  increaseOnHand(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId, quantity: string): Promise<StockLevel>;
  ...
  decreaseOnHand(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId, quantity: string): Promise<StockLevel>;
  /** Increases reserved quantity. Throws {@link InsufficientStockError} if it would exceed available quantity. */
  increaseReserved(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId, quantity: string): Promise<StockLevel>;
  /** Decreases reserved quantity. Never goes below `0`. */
  decreaseReserved(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId, quantity: string): Promise<StockLevel>;
  ...
  increaseDamaged(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId, quantity: string): Promise<StockLevel>;
  /** Decreases damaged quantity. Never goes below `0`. */
  decreaseDamaged(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId, quantity: string): Promise<StockLevel>;
}

/** Creates a real {@link InventoryStockEngine} backed by a {@link StockLevelRepository}. */
export function createInventoryStockEngine(repository: StockLevelRepository, now: () => string = nowIso): InventoryStockEngine {
  async function requireLevel(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId): Promise<StockLevel> {
  ...
  async function getOrCreateLevel(organizationId: OrganizationId, itemId: InventoryItemId, warehouseId: WarehouseId): Promise<StockLevel> {
  ...
  return {
    async getOrCreate(organizationId, itemId, warehouseId) {
      return getOrCreateLevel(organizationId, itemId, warehouseId);
    },
    ...
    async listBelowReorderPoint(organizationId) {
      ...
      return levels.filter((level) => isBelowReorderPoint(computeAvailableQuantity(level), level.reorderPoint));
    },
    ...
    async increaseOnHand(organizationId, itemId, warehouseId, quantity) {
      ...
      const updated: StockLevel = { ...level, quantityOnHand: addAmounts(level.quantityOnHand, quantity), updatedAt: now() };
      await repository.save(updated);
      return updated;
    },
    ...
    async decreaseOnHand(organizationId, itemId, warehouseId, quantity) {
      ...
      const updated: StockLevel = { ...level, quantityOnHand: subtractAmounts(level.quantityOnHand, quantity), updatedAt: now() };
      await repository.save(updated);
      return updated;
    },
    ...
    async increaseReserved(organizationId, itemId, warehouseId, quantity) {
      ...
      const updated: StockLevel = { ...level, reservedQuantity: addAmounts(level.reservedQuantity, quantity), updatedAt: now() };
      await repository.save(updated);
      return updated;
    },
    ...
    async increaseDamaged(organizationId, itemId, warehouseId, quantity) {
      const level = await requireLevel(organizationId, itemId, warehouseId);
      const updated: StockLevel = { ...level, damagedQuantity: addAmounts(level.damagedQuantity, quantity), updatedAt: now() };
      await repository.save(updated);
      return updated;
    },
