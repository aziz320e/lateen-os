...
import { STUDIO_SECTIONS } from '@/lib/types/automation';
      ...
      <div className="flex-1">
        <header className="border-b bg-card/30 px-6 py-4">
          <div className="flex items-center gap-2">
            <Workflow className="h-5 w-5 text-primary" />
            <h1 className="text-lg font-semibold">{title ?? 'Automation Studio'}</h1>
          </div>
          <p className="mt-1 text-xs text-muted-foreground">Design only — execution via Workflow Engine, Mission Scheduler, AI Runtime, Decision Engine</p>
        </header>
