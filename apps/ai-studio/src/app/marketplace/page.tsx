  ...
  return (
    <StudioShell title="Marketplace">
      <div className="mb-4 flex justify-between">
        <p className="text-sm text-muted-foreground">Publish, install, clone, and rate workers</p>
        <Button disabled>Publish Worker (stub)</Button>
      </div>
        ...
        {listings?.map((l) => (
          <Card key={l.id}>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">by {l.publisher}</p>
            </CardHeader>
